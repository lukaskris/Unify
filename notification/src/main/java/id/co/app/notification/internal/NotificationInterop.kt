...
/**
 * Created by Lukas Kristianto on 15/09/21 21.09.
 * Sinarmas APP
...
import id.co.app.notification.internal.utils.Utils
...
internal object NotificationInterop {
    ...
    fun buildNotification(notificationDelivery: NotificationDelivery, payload: RawNotification): NotificationCompat.Builder {
        val builder = NotificationCompat.Builder(notificationDelivery.context, payload.alerting.channelKey)
        ...
        payload.alerting.apply {
            ...
            if (lightColor != NotificationDelivery.NO_LIGHTS) {
            ...
            if (channelImportance >= NotificationDelivery.IMPORTANCE_NORMAL) {
        ...
        payload.stackable?.let {
            ...
            val activeNotifications = getActiveNotifications(NotificationDelivery.defaultConfig.notificationManager!!)
