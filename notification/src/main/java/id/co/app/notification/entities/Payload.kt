...
import id.co.app.notification.R
import id.co.app.notification.internal.utils.Action
import id.co.app.notification.internal.utils.NotifyImportance
...
sealed class Payload {
    ...
    data class Alerts(
         ...
         */
        val channelKey: String = NotificationDelivery.CHANNEL_DEFAULT_KEY,
        /**
         * The default CHANNEL_NAME for a notification on versions >= Android O.
         */
        var channelName: String = NotificationDelivery.CHANNEL_DEFAULT_NAME,
        /**
         * The default CHANNEL_DESCRIPTION for a notification on versions >= Android O.
         */
        var channelDescription: String = NotificationDelivery.CHANNEL_DEFAULT_DESCRIPTION,
        /**
         * The default IMPORTANCE for a notification.
         */
        @NotifyImportance var channelImportance: Int = NotificationDelivery.IMPORTANCE_NORMAL,
        /**
         * The LED colors of the notification notifyChannel.
         */
        @ColorInt var lightColor: Int = NotificationDelivery.NO_LIGHTS,
        /**
         * Vibration pattern for notification on this notifyChannel. This is only set on
         * notifications with importance that is at least [NotificationDelivery.IMPORTANCE_NORMAL] or higher.
         */
         ...
         * that is at least [NotificationDelivery.IMPORTANCE_NORMAL] or higher.
         */
    ...
    data class Header(
         ...
         */
        @DrawableRes var icon: Int = R.drawable.ic_baseline_notifications_active_24,
        /**
