...
import id.co.app.notification.entities.NotificationConfig
import id.co.app.notification.internal.NotificationChannelInterop
import id.co.app.notification.internal.NotificationInterop
import id.co.app.notification.internal.RawNotification

/**
 * Created by Lukas Kristianto on 15/09/21 20.56.
 * Sinarmas APP
 ...
 */
class NotificationDelivery internal constructor(internal var context: Context) {
    ...
    companion object {
        ...
        internal var defaultConfig = NotificationConfig()
         ...
         */
        fun defaultConfig(init: NotificationConfig.() -> Unit) {
            defaultConfig.init()
        }
        ...
        fun with(context: Context): NotificationCreator {
            return NotificationCreator(NotificationDelivery(context))
        }
