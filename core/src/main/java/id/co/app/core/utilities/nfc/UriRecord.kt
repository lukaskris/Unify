...
/**
 * Created by Lukas Kristianto on 09/09/21 09.21.
 * Sinarmas APP
...
class UriRecord(private val uri: Uri) : ParsedNdefRecord {
    ...
    companion object {
         ...
         */
        private val URI_PREFIX_MAP: com.google.common.collect.BiMap<Byte, String> =
            com.google.common.collect.ImmutableBiMap.builder<Byte, String>()
                .put(0x00.toByte(), "")
         ...
         * the URI.
         */
            val prefix: String = URI_PREFIX_MAP.get(payload[0]).orEmpty()
            val fullUri: ByteArray = com.google.common.primitives.Bytes.concat(
                prefix.toByteArray(
