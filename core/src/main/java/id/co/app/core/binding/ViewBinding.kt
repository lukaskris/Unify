...
object ViewBinding {
    ...
    @JvmStatic
    @BindingAdapter("unifyButtonVariantString")
    fun bindUnifyButtonVariant(view: UnifyButton, description: String) {
        view.buttonVariant = when(description){
            "ghost" -> UnifyButton.Variant.GHOST
            "filled" -> UnifyButton.Variant.FILLED
            else -> UnifyButton.Variant.TEXT_ONLY
        }
    }

    @JvmStatic
    @BindingAdapter("unifyButtonInverse")
    fun bindUnifyButtonVariant(view: UnifyButton, inverse: Boolean) {
        view.isInverse = inverse
    }

    @JvmStatic
    @BindingAdapter("unifyButtonLoadingState")
    fun bindUnifyButtonLoadingState(view: UnifyButton, isLoading: Boolean) {
        view.isLoading = isLoading
    }

    @JvmStatic
    @BindingAdapter("android:enabled")
    fun bindEnabled(view: View, isEnabled: Boolean){
