...
val defaultNoLSDownloaderError = LSDownloaderError.NONE
...
val defaultFileServerDownloader: FileServerDownloader = LSDownloaderFileServerDownloader()
val defaultLogger: Logger = LSDownloaderLogger(DEFAULT_LOGGING_ENABLED, DEFAULT_TAG)
