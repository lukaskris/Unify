 ...
 * */
enum class LSDownloaderError constructor(
        /** Error Value*/
        val value: Int,
    ...
    FETCH_DATABASE_LSDownloader_ERROR(11),
    ...
    UNKNOWN_IO_LSDownloader_ERROR(16),
    ...
    companion object {
        ...
        @JvmStatic
        fun valueOf(value: Int): LSDownloaderError {
            return when (value) {
                -1 -> UNKNOWN
                0 -> NONE
                1 -> FILE_NOT_CREATED
                ...
                11 -> FETCH_DATABASE_LSDownloader_ERROR
                13 -> REQUEST_WITH_ID_ALREADY_EXIST
                15 -> REQUEST_NOT_SUCCESSFUL
                16 -> UNKNOWN_IO_LSDownloader_ERROR
                17 -> FILE_NOT_FOUND
