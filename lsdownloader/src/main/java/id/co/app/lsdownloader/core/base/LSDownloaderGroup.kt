...
interface LSDownloaderGroup {
     ...
     * */
    val observers: Set<LSDownloaderObserver<List<Download>>>
     ...
     * */
    fun addFetchGroupObservers(vararg fetchGroupObservers: LSDownloaderGroupObserver)

    /**
     * Removes FetchGroupObservers attached to this fetch group.
     * @param fetchGroupObservers to be removed.
     * */
    fun removeFetchGroupObservers(vararg fetchGroupObservers: LSDownloaderGroupObserver)
