...
class LSDownloaderDatabaseManagerImpl constructor(
    context: Context,
...
) : LSDownloaderDatabaseManager<DownloadInfo> {
    ...
    override var delegate: LSDownloaderDatabaseManager.Delegate<DownloadInfo>? = null
    ...
    override fun getDownloadByTag(tag: String): Flow<DownloadInfo?> {
        throwExceptionIfClosed()
        return requestDatabase.requestDao().getDownloadByTagFlow(tag)
    }
