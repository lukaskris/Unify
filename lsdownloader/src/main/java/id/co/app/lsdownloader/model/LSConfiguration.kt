...
import id.co.app.lsdownloader.core.DefaultStorageResolver
...
import id.co.app.lsdownloader.core.database.LSDownloaderDatabaseManager
 ...
 */
class LSConfiguration private constructor(val appContext: Context,
                                          ...
                                          val fetchNotificationManager: LSDownloaderNotificationManager?,
                                          val fetchDatabaseManager: LSDownloaderDatabaseManager<DownloadInfo>?,
    ...
    class Builder(context: Context) {
        ...
        private var fetchNotificationManager: LSDownloaderNotificationManager? = null
        private var fetchDatabaseManager: LSDownloaderDatabaseManager<DownloadInfo>? = null
        ...
        private var fetchHandler: LSDownloaderHandler? = null
         ...
         * to see its use.
         * @param LSDownloaderNotificationManager the notification manager. If null, notifications
         * are not enabled on the Fetch instances created by this configuration.
         * @return Builder
         * */
        fun setNotificationManager(LSDownloaderNotificationManager: LSDownloaderNotificationManager?): Builder {
            this.fetchNotificationManager = LSDownloaderNotificationManager
            return this
        }
         ...
         * default use.
         * @param LSDownloaderDatabaseManager the Fetch database managers.
         * @return Builder
         * */
        fun setDatabaseManager(LSDownloaderDatabaseManager: LSDownloaderDatabaseManager<DownloadInfo>?): Builder {
            this.fetchDatabaseManager = LSDownloaderDatabaseManager
            return this
        }
         ...
         * */
        fun setFetchHandler(fetchHandler: LSDownloaderHandler): Builder {
         ...
         * */
        fun build(): LSConfiguration {
            val prefsLogger = logger
            if (prefsLogger is LSDownloaderLogger) {
