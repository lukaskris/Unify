...
import id.co.app.lsdownloader.utils.DEFAULT_ENABLE_LISTENER_NOTIFY_ON_ATTACHED
import id.co.app.lsdownloader.utils.DEFAULT_ENABLE_LISTENER_NOTIFY_ON_REQUEST_UPDATED
import kotlinx.coroutines.flow.Flow


/**
 * Created by Lukas Kristianto on 23/09/22 09.57.
 * Sinarmas APP
 * lukas_kristianto@app.co.id
 */
interface LSDownloader {
     ...
     * */
    val fetchConfiguration: LSConfiguration
     ...
     * @return Instance
     * */
    fun enqueue(request: Request, func: Func<Request>? = null, func2: Func<LSDownloaderError>? = null): LSDownloader
     ...
     * @return Instance
     * */
    fun enqueue(requests: List<Request>, func: Func<List<Pair<Request, LSDownloaderError>>>? = null): LSDownloader
     ...
     * @return Instance
     * */
    fun pause(ids: List<Int>, func: Func<List<Download>>? = null, func2: Func<LSDownloaderError>? = null): LSDownloader
     ...
     * @return Instance
     * */
    fun pause(ids: List<Int>): LSDownloader
     ...
     * @return Instance
     * */
    fun pause(id: Int, func: Func<Download>? = null, func2: Func<LSDownloaderError>? = null): LSDownloader
     ...
     * @return Instance
     * */
    fun pauseGroup(id: Int, func: Func<List<Download>>? = null, func2: Func<LSDownloaderError>? = null): LSDownloader
     ...
     * @return Instance
     * */
    fun pauseGroup(id: Int): LSDownloader
     ...
     * @return Instance
     * */
    fun freeze(func: Func<Boolean>? = null, func2: Func<LSDownloaderError>? = null): LSDownloader
     ...
     * @return Instance
     * */
    fun resume(ids: List<Int>, func: Func<List<Download>>? = null, func2: Func<LSDownloaderError>? = null): LSDownloader
     ...
     * @return Instance
     * */
    fun resume(ids: List<Int>): LSDownloader
     ...
     * @return Instance
     * */
    fun resume(id: Int, func: Func<Download>? = null, func2: Func<LSDownloaderError>? = null): LSDownloader
     ...
     * @return Instance
     * */
    fun resume(id: Int): LSDownloader
     ...
     * @return Instance
     * */
    fun resumeGroup(id: Int, func: Func<List<Download>>? = null, func2: Func<LSDownloaderError>? = null): LSDownloader
     ...
     * @return Instance
     * */
    fun resumeGroup(id: Int): LSDownloader
     ...
     * @return Instance
     * */
    fun unfreeze(func: Func<Boolean>? = null, func2: Func<LSDownloaderError>? = null): LSDownloader
     ...
     * @return Instance
     * */
    fun remove(ids: List<Int>, func: Func<List<Download>>? = null, func2: Func<LSDownloaderError>? = null): LSDownloader
     ...
     * @return Instance
     * */
    fun remove(ids: List<Int>): LSDownloader
     ...
     * @return Instance
     * */
    fun remove(id: Int, func: Func<Download>? = null, func2: Func<LSDownloaderError>? = null): LSDownloader
     ...
     * @return Instance
     * */
    fun remove(id: Int): LSDownloader
     ...
     * @return Instance
     * */
    fun removeGroup(id: Int, func: Func<List<Download>>? = null, func2: Func<LSDownloaderError>? = null): LSDownloader
     ...
     * @return Instance
     * */
    fun removeGroup(id: Int): LSDownloader
     ...
     * @return Instance
     * */
    fun removeAll(func: Func<List<Download>>? = null, func2: Func<LSDownloaderError>? = null): LSDownloader
     ...
     * @return Instance
     * */
    fun removeAllWithStatus(status: Status, func: Func<List<Download>>? = null, func2: Func<LSDownloaderError>? = null): LSDownloader
     ...
     * @return Instance
     * */
    fun removeAllWithStatus(status: Status): LSDownloader
     ...
     * @return Instance
     * */
    fun removeAllInGroupWithStatus(id: Int, statuses: List<Status>, func: Func<List<Download>>?, func2: Func<LSDownloaderError>? = null): LSDownloader
     ...
     * @return Instance
     * */
    fun removeAllInGroupWithStatus(id: Int, statuses: List<Status>): LSDownloader
     ...
     * @return Instance
     * */
    fun delete(ids: List<Int>, func: Func<List<Download>>? = null, func2: Func<LSDownloaderError>? = null): LSDownloader
     ...
     * @return Instance
     * */
    fun delete(ids: List<Int>): LSDownloader
     ...
     * @return Instance
     * */
    fun delete(id: Int, func: Func<Download>? = null, func2: Func<LSDownloaderError>? = null): LSDownloader
     ...
     * @return Instance
     * */
    fun delete(id: Int): LSDownloader
     ...
     * @return Instance
     * */
    fun deleteGroup(id: Int, func: Func<List<Download>>? = null, func2: Func<LSDownloaderError>? = null): LSDownloader
     ...
     * @return Instance
     * */
    fun deleteGroup(id: Int): LSDownloader
     ...
     * @return Instance
     * */
    fun deleteAll(func: Func<List<Download>>? = null, func2: Func<LSDownloaderError>? = null): LSDownloader
     ...
     * @return Instance
     * */
    fun deleteAllWithStatus(status: Status, func: Func<List<Download>>? = null, func2: Func<LSDownloaderError>? = null): LSDownloader
     ...
     * @return Instance
     * */
    fun deleteAllWithStatus(status: Status): LSDownloader
     ...
     * @return Instance
     * */
    fun deleteAllInGroupWithStatus(id: Int, statuses: List<Status>, func: Func<List<Download>>?, func2: Func<LSDownloaderError>? = null): LSDownloader
     ...
     * @return Instance
     * */
    fun deleteAllInGroupWithStatus(id: Int, statuses: List<Status>): LSDownloader
     ...
     * @return Instance
     * */
    fun cancel(ids: List<Int>, func: Func<List<Download>>? = null, func2: Func<LSDownloaderError>? = null): LSDownloader
     ...
     * @return Instance
     * */
    fun cancel(ids: List<Int>): LSDownloader
     ...
     * @return Instance
     * */
    fun cancel(id: Int, func: Func<Download>? = null, func2: Func<LSDownloaderError>? = null): LSDownloader
     ...
     * @return Instance
     * */
    fun cancel(id: Int): LSDownloader
     ...
     * @return Instance
     * */
    fun cancelGroup(id: Int, func: Func<List<Download>>? = null, func2: Func<LSDownloaderError>? = null): LSDownloader
     ...
     * @return Instance
     * */
    fun cancelGroup(id: Int): LSDownloader
     ...
     * @return Instance
     * */
    fun cancelAll(func: Func<List<Download>>? = null, func2: Func<LSDownloaderError>? = null): LSDownloader
     ...
     * @return Instance
     * */
    fun retry(ids: List<Int>, func: Func<List<Download>>? = null, func2: Func<LSDownloaderError>? = null): LSDownloader
     ...
     * @return Instance
     * */
    fun retry(ids: List<Int>): LSDownloader
     ...
     * @return Instance
     * */
    fun retry(id: Int, func: Func<Download>? = null, func2: Func<LSDownloaderError>? = null): LSDownloader
    ...
    fun updateRequest(requestId: Int,
                      ...
                      func2: Func<LSDownloaderError>? = null): LSDownloader
     ...
     * @return Instance
     * */
    fun replaceExtras(id: Int, extras: Extras, func: Func<Download>? = null, func2: Func<LSDownloaderError>? = null): LSDownloader
     ...
     * @return Instance
     * */
    fun resetAutoRetryAttempts(downloadId: Int, retryDownload: Boolean = true, func: Func2<Download?>? = null, func2: Func<LSDownloaderError>? = null): LSDownloader
     ...
     * @return Instance
     * */
    fun renameCompletedDownloadFile(id: Int, newFileName: String, func: Func<Download>? = null, func2: Func<LSDownloaderError>? = null): LSDownloader
     ...
     * @return Instance
     * */
    fun getDownloads(func: Func<List<Download>>): LSDownloader
     ...
     * @return Instance
     * */
    fun getDownloads(idList: List<Int>, func: Func<List<Download>>): LSDownloader
     ...
     * @return Instance
     * */
    fun getDownload(id: Int, func2: Func2<Download?>): LSDownloader
     ...
     * @return Instance
     * */
    fun getDownloadsInGroup(groupId: Int, func: Func<List<Download>>): LSDownloader
     ...
     * @return Instance
     * */
    fun getDownloadsWithStatus(status: Status, func: Func<List<Download>>): LSDownloader
     ...
     * @return Instance
     * */
    fun getDownloadsWithStatus(statuses: List<Status>, func: Func<List<Download>>): LSDownloader
     ...
     * @return Instance
     * */
    fun getDownloadsInGroupWithStatus(groupId: Int, statuses: List<Status>, func: Func<List<Download>>): LSDownloader
     ...
     * @return Instance
     * */
    fun getDownloadsByRequestIdentifier(identifier: Long, func: Func<List<Download>>): LSDownloader
     ...
     * @return Instance
     * */
    fun getDownloadsByTag(tag: String, func: Func<List<Download>>): LSDownloader
     ...
     * */
    fun getDownloadByTag(tag: String): Flow<Download?>
     ...
     * @return Instance.
     * */
    fun getFetchGroup(group: Int, func: Func<LSDownloaderGroup>): LSDownloader
     ...
     * @return Instance.
     * */
    fun getAllGroupIds(func: Func<List<Int>>): LSDownloader
     ...
     * @return Instance
     * */
    fun addListener(listener: LSDownloaderListener): LSDownloader
     ...
     * @return Instance
     * */
    fun addListener(listener: LSDownloaderListener, notify: Boolean = DEFAULT_ENABLE_LISTENER_NOTIFY_ON_ATTACHED): LSDownloader
     ...
     * @return Instance
     * */
    fun addListener(listener: LSDownloaderListener, notify: Boolean = DEFAULT_ENABLE_LISTENER_NOTIFY_ON_ATTACHED, autoStart: Boolean): LSDownloader

    /**
     * Remove all listener
     * @Return Instance
     */
    fun clearListener() : LSDownloader
     ...
     * @return Instance
     * */
    fun removeListener(listener: LSDownloaderListener): LSDownloader
     ...
     * @return Instance
     * */
    fun addCompletedDownload(completedDownload: CompletedDownload, alertListeners: Boolean = true, func: Func<Download>? = null, func2: Func<LSDownloaderError>? = null): LSDownloader
     ...
     * @return Instance
     * */
    fun addCompletedDownloads(completedDownloads: List<CompletedDownload>, alertListeners: Boolean = true, func: Func<List<Download>>? = null, func2: Func<LSDownloaderError>? = null): LSDownloader
     ...
     * @return Instance
     * */
    fun getDownloadBlocks(downloadId: Int, func: Func<List<DownloadBlock>>): LSDownloader
     ...
     * @return Instance
     * */
    fun getContentLengthForRequest(request: Request, fromServer: Boolean, func: Func<Long>, func2: Func<LSDownloaderError>?): LSDownloader
     ...
     * @return Instance
     * */
    fun getContentLengthForRequests(requests:List<Request>, fromServer: Boolean, func: Func<List<Pair<Request,Long>>>, func2: Func<List<Pair<Request, LSDownloaderError>>>): LSDownloader
     ...
     * @return Instance
     * */
    fun getServerResponse(url: String, headers: Map<String, String>?, func: Func<Downloader.Response>, func2: Func<LSDownloaderError>? = null): LSDownloader
     ...
     * @return Instance
     * */
    fun getFetchFileServerCatalog(request: Request, func: Func<List<FileResource>>, func2: Func<LSDownloaderError>? = null): LSDownloader
     ...
     * @return Instance
     * */
    fun enableLogging(enabled: Boolean): LSDownloader
     ...
     * @return Instance
     * */
    fun setGlobalNetworkType(networkType: NetworkType): LSDownloader
     ...
     * @return Instance
     * */
    fun setDownloadConcurrentLimit(downloadConcurrentLimit: Int): LSDownloader
     ...
     * */
    fun getListenerSet(): Set<LSDownloaderListener>
     ...
     * @return instance
     * */
    fun attachFetchObserversForDownload(downloadId: Int, vararg fetchObservers: LSDownloaderObserver<Download>): LSDownloader
     ...
     * @return instance
     * */
    fun removeFetchObserversForDownload(downloadId: Int, vararg fetchObservers: LSDownloaderObserver<Download>): LSDownloader
     ...
     * @return instance
     * */
    fun hasActiveDownloads(includeAddedDownloads: Boolean, func: Func<Boolean>): LSDownloader
     ...
     * @return instance
     * */
    fun addActiveDownloadsObserver(includeAddedDownloads: Boolean = false, fetchObserver: LSDownloaderObserver<Boolean>): LSDownloader

    /** Removes a subscribed FetchObserver that is listening for active downloads.
     * @param lsDownloaderObserver the fetch observer to remove.
     * @throws FetchException if this instance of Fetch has been closed.
     * @return instance
     * */
    fun removeActiveDownloadsObserver(lsDownloaderObserver: LSDownloaderObserver<Boolean>): LSDownloader
...
//        @Volatile
//        private var defaultFetchConfiguration: LSConfiguration? = null
//        @Volatile
//        private var defaultFetchInstance: LSDownloader? = null

        /**
         * Sets the default Configuration settings on the default Fetch instance.
         * @param fetchConfiguration custom Fetch Configuration
         * */
//        fun setDefaultInstanceConfiguration(fetchConfiguration: LSConfiguration) {
//            synchronized(lock) {
...
//        }
        ...
        /**
         * Get the default Fetch Configuration set with setDefaultInstanceConfiguration(fetchConfiguration: LSDownloaderConfiguration)
         * or setDefaultInstanceConfiguration(context: Context)
         * @return default FetchConfiguration
         * */
//        fun getDefaultFetchConfiguration(): LSConfiguration? {
...
//        }
         ...
         * */
//        fun getDefaultInstance(): LSDownloader {
//            return synchronized(lock) {
...
//                    val newDefaultFetch = LSDownloaderImpl.newInstance(LSDownloaderModulesBuilder.buildModulesFromPrefs(fetchConfiguration))
...
//        }
         ...
         * */
        fun getInstance(fetchConfiguration: LSConfiguration): LSDownloader {
            return LSDownloaderImpl.newInstance(LSDownloaderModulesBuilder.buildModulesFromPrefs(fetchConfiguration))
        }
