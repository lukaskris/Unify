...
class LSDownloaderDatabaseManagerWrapper(private val fetchDatabaseManager: LSDownloaderDatabaseManager<DownloadInfo>): LSDownloaderDatabaseManager<DownloadInfo> {
    ...
    override var delegate: LSDownloaderDatabaseManager.Delegate<DownloadInfo>?
        get() {
            return synchronized(lock) {
    ...
    override fun getDownloadByTag(tag: String): Flow<DownloadInfo?> = fetchDatabaseManager.getDownloadByTag(tag)
