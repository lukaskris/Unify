...
const val ACTION_QUEUE_BACKOFF_RESET = "id.co.app.lsdownloader.action.QUEUE_BACKOFF_RESET"
...
const val EXTRA_NAMESPACE = "id.co.app.lsdownloader.extra.NAMESPACE"
const val EXTRA_DOWNLOAD_ID = "id.co.app.lsdownloader.extra.DOWNLOAD_ID"
const val EXTRA_DOWNLOAD_NOTIFICATIONS = "con.tonyodev.fetch2.extra.DOWNLOAD_NOTIFICATIONS"
const val EXTRA_NOTIFICATION_ID = "id.co.app.lsdownloader.extra.NOTIFICATION_ID"
const val EXTRA_NOTIFICATION_GROUP_ID = "id.co.app.lsdownloader.extra.NOTIFICATION_GROUP_ID"
const val EXTRA_ACTION_TYPE = "id.co.app.lsdownloader.extra.ACTION_TYPE"
const val EXTRA_GROUP_ACTION = "id.co.app.lsdownloader.extra.GROUP_ACTION"
