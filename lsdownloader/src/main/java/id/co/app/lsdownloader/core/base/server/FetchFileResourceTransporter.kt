...
import id.co.app.lsdownloader.core.base.server.FileRequest.CREATOR.FIELD_CLIENT
import id.co.app.lsdownloader.core.base.server.FileResponse.CREATOR.FIELD_CONTENT_LENGTH
import id.co.app.lsdownloader.core.base.server.FileResponse.CREATOR.FIELD_DATE
import id.co.app.lsdownloader.core.base.server.FileResponse.CREATOR.FIELD_MD5
import id.co.app.lsdownloader.core.base.server.FileResponse.CREATOR.FIELD_SESSION_ID
import id.co.app.lsdownloader.core.base.server.FileResponse.CREATOR.FIELD_STATUS
import id.co.app.lsdownloader.core.base.server.FileResponse.CREATOR.FIELD_TYPE
...
class FetchFileResourceTransporter(private val client: Socket = Socket()) : FileResourceTransporter {
    ...
    override fun receiveFileResponse(): FileResponse? {
        return synchronized(lock) {
            ...
            val connection = json.getInt(FIELD_CLIENT)
