 ...
 * */
interface LSDownloaderHandler : Closeable {

    fun init()
    fun enqueue(request: Request): Pair<Download, LSDownloaderError>
    fun enqueue(requests: List<Request>): List<Pair<Download, LSDownloaderError>>
    ...
    fun addListener(listener: LSDownloaderListener, notify: Boolean, autoStart: Boolean)
    fun removeListener(listener: LSDownloaderListener)
    fun clearListener()
    ...
    fun getFetchGroup(id: Int): LSDownloaderGroup
