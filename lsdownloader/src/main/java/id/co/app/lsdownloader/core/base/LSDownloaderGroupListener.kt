 ...
 * */
interface LSDownloaderGroupListener: LSDownloaderListener {
     ...
     * */
    fun onAdded(groupId: Int, download: Download, fetchGroup: LSDownloaderGroup)
     ...
     * about a specific download group managed by Fetch.
     * */
    fun onQueued(groupId: Int, download: Download, waitingNetwork: Boolean, fetchGroup: LSDownloaderGroup)
     ...
     * about a specific download group managed by Fetch.
     * */
    fun onStarted(groupId: Int, download: Download, downloadBlocks: List<DownloadBlock>, totalBlocks: Int, fetchGroup: LSDownloaderGroup)
     ...
     * about a specific download group managed by Fetch.
     * */
    fun onCompleted(groupId: Int, download: Download, fetchGroup: LSDownloaderGroup)
     ...
     * about a specific download group managed by Fetch.
     * */
    fun onResumed(groupId: Int, download: Download, fetchGroup: LSDownloaderGroup)
     ...
     * about a specific download group managed by Fetch.
     * */
    fun onPaused(groupId: Int, download: Download, fetchGroup: LSDownloaderGroup)
     ...
     * about a specific download group managed by Fetch.
     * */
    fun onCancelled(groupId: Int, download: Download, fetchGroup: LSDownloaderGroup)
     ...
     * about a specific download group managed by Fetch.
     * */
    fun onRemoved(groupId: Int, download: Download, fetchGroup: LSDownloaderGroup)
     ...
     * about a specific download group managed by Fetch.
     * */
    fun onDeleted(groupId: Int, download: Download, fetchGroup: LSDownloaderGroup)
     ...
     * about a specific download group managed by Fetch.
     * */
    fun onWaitingNetwork(groupId: Int, download: Download, fetchGroup: LSDownloaderGroup)
     ...
     * @param download An immutable object which contains a current snapshot of all the information
     * about a specific download managed by Fetch.
     * @param LSDownloaderError the error that occurred
     * @param throwable the throwable that caused the error to occur. Maybe null.
     * @param fetchGroup An immutable object which contains a current snapshot of all the information
     * about a specific download group managed by Fetch.
     * */
    fun onError(groupId: Int, download: Download, LSDownloaderError: LSDownloaderError, throwable: Throwable?, fetchGroup: LSDownloaderGroup)
     ...
     * about a specific download group managed by Fetch.
     * */
    fun onDownloadBlockUpdated(groupId: Int, download: Download, downloadBlock: DownloadBlock, totalBlocks: Int, fetchGroup: LSDownloaderGroup)
     ...
     * @param LSDownloaderGroup An immutable object which contains a current snapshot of all the information
     * about a specific download group managed by Fetch.
     * */
    fun onProgress(groupId: Int, download: Download, etaInMilliSeconds: Long, downloadedBytesPerSecond: Long, LSDownloaderGroup: LSDownloaderGroup)
