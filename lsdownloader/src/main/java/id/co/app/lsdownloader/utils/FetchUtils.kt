...
import id.co.app.lsdownloader.core.base.Downloader
import id.co.app.lsdownloader.core.base.LSDownloaderHandler
import id.co.app.lsdownloader.core.base.FileSliceInfo
import id.co.app.lsdownloader.core.base.server.FileRequest
import id.co.app.lsdownloader.model.Request
...
fun awaitFinishOrTimeout(allowTimeInMilliseconds: Long, LSDownloaderHandler: LSDownloaderHandler) {
    ...
    var pendingCount = LSDownloaderHandler.getPendingCount()
    while (indefinite || (pendingCount > 0 && !hasAllowedTimeExpired)) {
        ...
        pendingCount = LSDownloaderHandler.getPendingCount()
    }
}
