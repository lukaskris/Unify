...
open class DownloadInfo : Download {
    ...
    override var lsDownloaderError: LSDownloaderError = defaultNoLSDownloaderError
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (lsDownloaderError != other.lsDownloaderError) return false
    ...
    override fun hashCode(): Int {
        ...
        result = 31 * result + lsDownloaderError.hashCode()
    ...
    override fun writeToParcel(dest: Parcel, flags: Int) {
        ...
        dest.writeInt(lsDownloaderError.value)
    ...
    override fun toString(): String {
        return "DownloadInfo(id=$id, namespace='$namespace', url='$url', file='$file', " +
                ...
                " total=$total, status=$status, error=$lsDownloaderError, networkType=$networkType, " +
    ...
    companion object CREATOR : Parcelable.Creator<DownloadInfo> {
        ...
        override fun createFromParcel(source: Parcel): DownloadInfo {
            ...
            val LSDownloaderError = LSDownloaderError.valueOf(source.readInt())
