package id.co.app.components.notify.entities
...
import id.co.app.components.notify.internal.utils.NotifyImportance
...
sealed class Payload {
    ...
    data class Header(
         ...
         */
        @DrawableRes var icon: Int = R.drawable.iconunify_bell_filled,
        /**
